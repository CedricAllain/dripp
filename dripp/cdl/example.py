# %%
from run_cdl import run_cdl_sample, run_cdl_somato, run_cdl_camcan
...
run_cdl = dict(
    sample=run_cdl_sample, somato=run_cdl_somato, camcan=run_cdl_camcan)
...
plot_atoms(u_hat, v_hat, info=dict_res['info'], plotted_atoms='all',
           sfreq=sfreq, fig_name=f'{DATASET}_all_atoms')

# plot activation distribution
plot_z_boxplot(z_hat, p_threshold=10, per_atom=True, yscale='log',
