...
for this_cond, this_evk in evks.items():
    ...
    fig.savefig(SAVE_RESULTS_PATH / fig_name.replace('pdf', 'jpg'))

fig = mne.viz.plot_compare_evokeds(evks, picks='mag',
                                   colors=dict(aud=0, vis=1),
                                   linestyles=dict(left='solid',
                                                   right='dashed'))
fig[0].savefig(SAVE_RESULTS_PATH / 'compare_evokeds_mag_sample.pdf')
fig[0].savefig(SAVE_RESULTS_PATH / 'compare_evokeds_mag_sample.jpg')
